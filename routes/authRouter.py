...
from controllers.authController import register_user, login_user, logout_user, get_users,get_logged_in_user, request_password_reset, reset_password_by_code, verify_reset_code
...
auth_bp.route('/verify-reset-code', methods=['POST'])(verify_reset_code)
